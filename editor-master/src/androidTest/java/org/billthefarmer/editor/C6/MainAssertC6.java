    ...
    public void mainAssertC6() {
        ...
        ViewInteraction textView = onView(
                allOf(withText("Editor.txt"),
                        isDisplayed()));
        textView.check(matches(withText("Editor.txt")));

        ViewInteraction textView2 = onView(
                Matchers.allOf(ViewMatchers.withId(R.id.edit), isDisplayed()));
        textView2.check(matches(isDisplayed()));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.open),
                        isDisplayed()));
