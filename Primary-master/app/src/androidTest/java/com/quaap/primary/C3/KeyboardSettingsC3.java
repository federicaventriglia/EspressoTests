...
public class KeyboardSettingsC3 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void keyboardSettingsC3() {
        openActionBarOverflowOrOptionsMenu(getInstrumentation().getTargetContext());

        ViewInteraction appCompatTextView = onView(
                allOf(ViewMatchers.withId(R.id.title),
                        childAtPosition(
                                childAtPosition(
                ...
                .inAdapterView(allOf(withId(android.R.id.list),
                        childAtPosition(
                                allOf(withId(android.R.id.list_container),
                                        childAtPosition(
                                                childAtPosition(
                                                        allOf(withClassName(is("android.preference.PreferenceFrameLayout")),
                                                                childAtPosition(
