...
public class PlayProjectTest {
    ...
    public void playProjectTest() {
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.stage_dialog_button_back), withText("Indietro"),
                        childAtPosition(
                                allOf(withId(R.id.stage_layout_linear),
                                        childAtPosition(
                                                allOf(withId(R.id.stage_layout_relative),
                                                        childAtPosition(
                                                                allOf(withId(android.R.id.content),
                                                                        childAtPosition(
                                                                                withClassName(is("android.widget.FrameLayout")),
